 ...
 *  [ ] Унифицироварь рекурсивный метод обхода реестра
 *      - убрать привязку к удалению значения и пустых веток
 *      - реализовать передачу callback-функций для выполнения действий для конечного элемента пути и для всплытий
